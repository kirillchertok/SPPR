...
namespace WEB_253502_Chertok.BlazorWasm.Services
{
	public class DataService : IDataService
	{
		...
		public async Task GetProductListAsync(string? categoryNormalizedName, int pageNo = 1)
		{
			...
			try
			{
				var route = new StringBuilder($"{_httpClient.BaseAddress.AbsoluteUri}Products/");
				...
				var data = await response.Content.ReadFromJsonAsync<ResponseData<ProductListModel<Product>>>
